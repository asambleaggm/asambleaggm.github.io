...
- M. => Se lanzan preguntas como ¿si se ve bien difundir el documento por los canales de Menos Lectivas? ¿Cómo lo movemos por el IES? ¿si lo movemos por deptos? ¿si ponemos una fecha tope? ¿como hacer el registro?
- S. => Comenta que en el Punto 3 del documento, la PTSC es la que debería encargarse de la derivación, pero al estar a media jornada, no le da la vida para tratar todo esto. Además, que ve imprescindible que vaya ligado a otros factores como salud mental, protocoles, etc...
- C. => Se comenta que el curso pasado a la CCP llegó un documento procedente de otro centro al cual podíamos adherirnos, sobre el uso de pinganillos y móviles en las aulas, ¿porque no lanzar nuestro documento a otros centros también?
...
- B. => Se comenta la importancia de que las PROPUESTAS DE MEJORA del centro, no vayan en contra de nuestras condiciones laborales.
...
### ACUERDOS:
- Se dan dos días, hasta el miércoles 4 par ahacer modificaciones o añadir algo al texto borrrador que se pasó por Whatsapp (Escribirle a él con el texto a incluir/modificar ya hecho, para que lo añada)
